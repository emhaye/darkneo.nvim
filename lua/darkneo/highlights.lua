local highlights = {
    ...
    WinSeparator = { fg = C.bg, bg = C.bg },
		...
		String = {fg = C.orange, },
		Character = {fg = C.green, style = "italic", },
		Constant = {fg = C.red, style = 'italic', },
		Number = {fg = C.light_green, },
		Boolean = {fg = C.yellow, style = "italic", },
		...
		Conditional = {fg = C.magenta, style = "italic", },
		Repeat = {fg = C.purple, },
		Label = {fg = C.purple, },
		Exception = {fg = C.purple, style = "italic", },
		Include = {fg = C.purple, },
		PreProc = {fg = C.purple, },
		Define = {fg = C.purple, },
		Macro = {fg = C.purple, },
